...
<style>
    ...
    <div class="bg-light p-5 rounded">
        @auth
           ...
           <form id="createRegForm" method="post" action="{{ route('users.store') }}">
        ...
        <button class="w-100 btn btn-lg btn-primary" type="submit" style="width: 40%;">Register</button>
