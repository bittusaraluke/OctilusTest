...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2022 at 12:45 PM
...
CREATE TABLE `country` (
  ...
  `countrySymbol` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `country` (`countryId`, `countrySymbol`, `countryName`, `phonecode`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `state` (
  `statesId` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `state` (`statesId`, `stateName`, `countryId`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `users` (`id`, `name`, `email`, `username`, `email_verified_at`, `password`, `firstname`, `lastname`, `gender`, `country`, `terms`, `newsletter`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, NULL, 'bittu@gmail.com', NULL, NULL, '$2y$10$PL4sINTQ1Aijva0Lm91fyOcvRA.BQqAKnSI9j4VdPlDRsP12XROCS', 'bittu', 'sara', 'female', '1', 'yes', NULL, NULL, '2022-09-16 05:19:41', '2022-09-16 05:19:41'),
(4, NULL, 'beena@gmail.com', NULL, NULL, '$2y$10$rdO60ir.TfADzZ3aQKYYyuiJ6MsWCVC8VC9iBT5ofQpw6jHcYuQzS', 'beena', 'shiju', 'male', 'Afghanistan', 'yes', NULL, NULL, '2022-09-17 05:08:15', '2022-09-17 05:08:15');
...
ALTER TABLE `state`
  ...
  ADD KEY `state_countryid_foreign` (`countryId`);
...
--
ALTER TABLE `country`
  MODIFY `countryId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;
